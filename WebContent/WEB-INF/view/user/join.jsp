      ...
      <form:form action="${root }join/join_proc" method="post" modelAttribute="userDTO">
        ...
        <div class="info">
          ...
          <div class ="joinmuen">
            ...
            <div class="joininput">
              ...
              <div>
                <button class="overlap" type="button" onclick="location.href='${root}join/signUp'">이메일 인증</button>
              </div>
        ...
        <div class ="addrinfo">
          ...
          <div>
            ...
            <div class="addrinput">
              <form:input path="mAddr" name="mAddr" class="postcodify_postcode5" /><br>
               <button type="button" id="postcodify_search_button" class="overlap">검색</button><br>
            ...
            <div class="addrinput">
              <form:input path="lAddr" name="lAddr" class="postcodify_address" /><br>
              <form:errors path="mAddr" class="addrerror"/>
            </div>
            <h4 class="addr">상세주소</h4>
            <div class="addrinput">
              <form:input path="dlAddr" name="dlAddr" class="postcodify_details" /><br>
