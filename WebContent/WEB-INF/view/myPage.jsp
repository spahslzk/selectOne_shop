		...
		<div class="info">
			<div class="order">
				<table class="myPageUserInfo">
					...
					<tbody>
						<tr height="100">
							<td style="padding-left: 50px; border-left: 0px;"><div
									class="base" style="text-align: left;">
					...
					<c:forEach var="mp" items="${mp }" end="4">
						...
						<tr>
							...
							<td>${fn:split(mp.ordName,',')[0]}<c:if
									test="${not empty fn:split(mp.ordName,',')[1]}"> 외 ${fn:length(fn:split(mp.ordName, ","))-1} 개</c:if>
							</td>
							...
							<td>배달완료</td>
							<td>
								<form action="${root }paymentView" method="post" target="POPUPW"
									...
									<div class="field">
										<input type="submit" name="sub" value="발 급"
											class="blue_button">
									</div>
								</form>
							</td>
			...
			<div id="contentWrapper" style="height: 100px !important;">
				<div id="contentWrap">
					...
					<table class="shopping_cart"
						...
						<thead>
							<tr>
								<th scope="row" style="background-color: white !important;"><div
										class="tb-center" style="margin-bottom: 40px !important;">
										<c:if test="${empty mp}">주문 내역이 없습니다</c:if>
									</div></th>
							</tr>
						</thead>
						<tbody>
					...
					<table class="shopping_cart"
						...
						<thead>
							<tr>
								<th scope="row" style="background-color: white !important;"><div
										class="tb-center" style="margin-bottom: 40px !important;">
										<c:if test="${empty cpList}">보유하고 계신 쿠폰 내역이 없습니다</c:if>
									</div></th>
							</tr>
						</thead>
						<tbody>
