...
public class GdsCartDTO {
	 ...
	 * [cart entity]
	 * 
	 * cartNum number PK not null, userNum number FK not null, gdsNum number FK not
	 * null, cartCount number not null, cartColor varchar2(50) not null
	 * 
	 */
	...
	public GdsCartDTO(long cartNum, long userNum, long gdsNum, int cartCount, String cartColor, int cartSize,
			int cartPrice) {
