...
public interface CartMapper {
	...
	@Select("SELECT cartNum,userNum,c.gdsNum,cartCount,gdsname,gdsprice,cartColor,cartSize,thumbImg FROM user_cart c left outer join gds_info g on c.gdsnum = g.gdsnum where c.usernum = #{userNum}")
	...
	//
	@Insert("insert into user_cart values(cart_num.nextval,#{userNum},#{gdsNum},#{cartCount},#{cartColor},#{cartSize})")
